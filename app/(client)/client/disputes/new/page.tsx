...
export default async function NewClientDisputePage() {
  const jobs = await getEligibleDisputeJobs();
  return (
    <div className="mx-auto max-w-3xl space-y-6 pb-20">
      <Link href="/client/disputes" className="text-xs font-black uppercase tracking-widest text-primary">Back to disputes</Link>
      <header>
      ...
      <DisputeCreateForm jobs={jobs as any[]} role="client" />
    </div>
  );
}
