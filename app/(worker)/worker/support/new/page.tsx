...
export default function NewWorkerSupportTicketPage() {
  async function create(formData: FormData) {
    ...
    redirect(`/worker/support/${result.ticketId}`);
  }

  return (
    <div className="mx-auto max-w-3xl space-y-6 pb-20">
      <Link href="/worker/support" className="text-xs font-black uppercase tracking-widest text-primary">Back to support</Link>
      <header>
