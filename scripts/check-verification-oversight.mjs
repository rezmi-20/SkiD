...
check("super admin cannot reveal full FIN", !superAdminBlock.includes('"verification.review"') && verificationOps.includes('"content_verification_admin"') && verificationOps.includes("Only content verification administrators may reveal FIN") && finReveal.includes("canReveal"));
